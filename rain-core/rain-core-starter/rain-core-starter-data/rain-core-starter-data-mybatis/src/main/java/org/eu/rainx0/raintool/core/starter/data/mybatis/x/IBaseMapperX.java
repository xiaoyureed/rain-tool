 ...
 */
public interface IBaseMapperX<ID, T extends AbstractIdEntity<ID>> extends BaseMapper<T> {

    default List<T> selectPage(IPageInfo pageInfo, @Param("ew") Wrapper<T> queryWrapper) {
        // MyBatis Plus 查询
